...
async def run_migration():
    ...
    # DATABASE_URL: postgresql+asyncpg://postgres.qpgwotsodziznwigpjey:postgresql%402025@aws-1-eu-west-1.pooler.supabase.com:6543/postgres
    print(f"Connecting with SQLAlchemy...")
