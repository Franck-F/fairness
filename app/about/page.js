    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <section className="px-5 py-14 sm:px-8 lg:px-10 lg:py-20">
        <div className="mx-auto grid max-w-7xl gap-5 sm:grid-cols-2 xl:grid-cols-4">
          {milestones.map((item) => (
            <div key={item.label} className="rounded-[26px] border border-white/10 bg-[#0e0e10] p-5">
      ...
      <section className="border-y border-white/8 bg-white/[0.015] px-5 py-14 sm:px-8 lg:px-10 lg:py-20">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="rounded-[30px] border border-white/10 bg-[linear-gradient(140deg,rgba(226,8,161,0.16),rgba(104,54,176,0.16)_42%,rgba(255,255,255,0.03))] p-6 sm:p-8">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {values.map((value) => {
              ...
              return (
                <div key={value.title} className="rounded-[26px] border border-white/10 bg-[#0d0d0f] p-5">
      ...
      <section className="border-y border-white/8 bg-white/[0.015] px-5 py-14 sm:px-8 lg:px-10 lg:py-20">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {team.map((member) => (
              <div key={member.name + member.role} className="rounded-[26px] border border-white/10 bg-[#0d0d0f] p-5">
