...
const plans = [
  {
    ...
    monthly: 37,
    annual: 31,
    description: 'Pour lancer les premiers audits et structurer la base de gouvernance.',
    cta: 'Démarrer',
    href: '/signup',
    featured: false,
    features: ['3 projets actifs', 'Mesures d équité essentielles', 'Rapports PDF', 'Support par e-mail'],
  },
  {
    name: 'Pro',
    monthly: 75,
    annual: 62,
    description: 'Pour les equipes qui industrialisent la revue des modeles a risque.',
  ...
  },
  {
    ...
    monthly: null,
    annual: null,
    description: 'Pour les organisations avec exigences fortes de preuve et conformité continue.',
    cta: 'Planifier un echange',
    href: '/contact',
    featured: false,
    features: ['SSO et gouvernance', 'Programmes dédiés', 'Conformité continue', 'Support expert'],
  },
]
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 max-w-4xl">
              ...
              <p className="mt-5 max-w-2xl text-sm leading-7 text-white/60 sm:text-base">
                Structure Framer conservee : trois offres claires, lisibles, avec un plan central mis en avant.
              </p>
            </div>

            <div className="mt-10 inline-flex items-center gap-3 rounded-full border border-white/10 bg-[#0d0d0f] px-4 py-2 text-sm text-white/70">
              <button
                type="button"
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-4 text-3xl font-semibold text-white">
                      {price === null ? 'Sur mesure' : `${price}EUR`}
                    </p>
      ...
      <section className="border-y border-white/8 bg-white/[0.015] px-5 py-14 sm:px-8 lg:px-10 lg:py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 space-y-4">
            {faqs.map((faq) => (
              <article key={faq.question} className="rounded-[24px] border border-white/10 bg-[#0d0d0f] p-5">
