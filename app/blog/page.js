  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <section className="px-5 pb-14 sm:px-8 lg:px-10 lg:pb-20">
        <div className="mx-auto max-w-7xl rounded-[32px] border border-white/10 bg-[#0d0d0f] p-5 sm:p-6">
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div className="rounded-[28px] border border-white/10 bg-[linear-gradient(140deg,rgba(226,8,161,0.16),rgba(104,54,176,0.16)_42%,rgba(255,255,255,0.03))] p-6">
      ...
      <section className="border-y border-white/8 bg-white/[0.015] px-5 py-14 sm:px-8 lg:px-10 lg:py-20">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {posts.map((post) => (
              <article key={post.title} className="rounded-[26px] border border-white/10 bg-[#0d0d0f] p-5">
